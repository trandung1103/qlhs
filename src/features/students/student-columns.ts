...
export const STUDENT_COLUMNS: StudentColumnDef[] = [
  ...
  { key: 'fatherWorkplace', label: 'Nơi công tác bố', defaultVisible: false, sortable: true, editKind: 'text', parseValue: parseText, getValue: (s) => s.fatherWorkplace ?? '' },
  ...
  { key: 'motherWorkplace', label: 'Nơi công tác mẹ', defaultVisible: false, sortable: true, editKind: 'text', parseValue: parseText, getValue: (s) => s.motherWorkplace ?? '' },
